			...
			<div className="container">
				<div className="row">
					<div className="col-lg-8 col-md-8 cal-sm-12 BG2">
						<p><span><i className="fa-solid fa-tag"></i></span>Niềng Răng</p>
						<h1>Chuyên Mục: Niềng Răng » Dental</h1>
					</div>
				</div>
			</div>
		</div>
				...
				<div className="col-lg-8 col-md-8 col-sm-12 col-12">
					<div className="row">
						...
						<div className="col-lg-10 col-md-10 col-sm-12 col-12">
							...
							<button className="button1"><a href="BlogNiengRangBlog1">Tiếp Tục Tìm Hiểu</a></button>
						</div>							
